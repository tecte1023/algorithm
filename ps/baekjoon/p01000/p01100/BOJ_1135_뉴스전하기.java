/*
 * 문제: 백준 1135번 - 뉴스 전하기 (https://www.acmicpc.net/problem/1135)
 * 문제 풀이
 *  ArrayList<HashMap<>>을 사용하여 인덱스가 직원i인 HashMap에는 키로 직원i의 직속 부하들, 값으로 직원i부터 직원i의 직·간접적인 부하까지 연락하는데 걸리는 시간을 저장.
